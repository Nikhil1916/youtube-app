...
export const buttonList = [
    ...
    {name:'news', id:6},
    {name:'cooking', id:7},
    {name:'valentines', id:8},
    {name:'one piece', id:9},
    {name:'javacript' , id:10},
    {name:"naruto", id:11},
    {name:'all' , id:1},
    {name:'game',id:2},
    {name:'song', id:3},
...
export const YOUTUBE_SEARCH_QUERY_API = "https://www.googleapis.com/youtube/v3/search?part=snippet%2Cstatistics&regionCode=IN&maxResults=50&key=AIzaSyCyW6Ift3mxGSzfYiwpvsgzOpFYQOmdR5g&q=iphine"